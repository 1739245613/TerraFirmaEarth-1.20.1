...
public class NTEBisonModel extends HierarchicalAnimatedModel<RammingPrey>
{
    public static LayerDefinition createBodyLayer()
    {
        ...
        tail.addOrReplaceChild("piece_r1", CubeListBuilder.create().texOffs(104, 68).addBox(-2.5F, 0.1889F, -1.3354F, 6.0F, 17.0F, 1.0F, new CubeDeformation(0.5F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.1309F, 0.0F, 0.0F));
        ...
        head.addOrReplaceChild("horn_1", CubeListBuilder.create().texOffs(100, 31).addBox(-3.5F, -6.0F, -0.9F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(90, 36).addBox(-1.5F, -2.0F, -0.9F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.0F, -3.5F, -6.6F));

        head.addOrReplaceChild("horn_2", CubeListBuilder.create().texOffs(42, 104).addBox(1.5F, -6.0F, -0.9F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(84, 36).addBox(0.5F, -2.0F, -0.9F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(6.0F, -3.5F, -6.6F));

        head.addOrReplaceChild("left_ear", CubeListBuilder.create().texOffs(76, 71).addBox(-2.0F, -2.0F, -4.0F, 3.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.4F, 4.5F, -6.5F));

        whole_body.addOrReplaceChild("leg_1", CubeListBuilder.create().texOffs(42, 84).addBox(-1.9F, -2.0F, -3.0F, 7.0F, 13.0F, 7.0F, new CubeDeformation(0.5F))
            .texOffs(84, 7).addBox(-1.5F, -2.0F, -3.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.5F, 6.0F, -11.0F));

        whole_body.addOrReplaceChild("leg_2", CubeListBuilder.create().texOffs(84, 7).addBox(-2.5F, -2.0F, -3.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.5F, 6.0F, 13.0F));

        whole_body.addOrReplaceChild("leg_3", CubeListBuilder.create().texOffs(42, 84).addBox(-3.1F, -3.0F, -4.0F, 7.0F, 13.0F, 7.0F, new CubeDeformation(0.5F))
            .texOffs(84, 7).addBox(-2.5F, -3.0F, -4.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(4.5F, 7.0F, -10.0F));

        whole_body.addOrReplaceChild("leg_4", CubeListBuilder.create().texOffs(84, 7).addBox(-3.5F, -2.0F, -3.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(5.5F, 6.0F, 13.0F));
    ...
    public NTEBisonModel(ModelPart root)
    {
        super(root);
        ...
        this.leg1 = this.bison.getChild("leg_1");
        this.leg2 = this.bison.getChild("leg_2");
        this.leg3 = this.bison.getChild("leg_3");
        this.leg4 = this.bison.getChild("leg_4");
    }
