...
public class NTELeopardSealModel extends HierarchicalAnimatedModel<NTELeopardSeal>
{
    ...
    public NTELeopardSealModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(NTELeopardSeal animal, float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch)
    {
